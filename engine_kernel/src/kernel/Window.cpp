...
namespace MatrixEngine
{
    ...
    int Window::init() {
        LOG_INFO("Initialize class Window '{0}' width size {1}x{2}", m_data.title, m_data.width, m_data.height);
        ...
        p_colors_vbo = std::make_unique<VertexBuffer>(points_color, sizeof(points_color));
