...
namespace MatrixEngine
{
    ...
    VertexBuffer& VertexBuffer::operator=(MatrixEngine::VertexBuffer && vertexBuffer) noexcept {
    ...
    VertexBuffer::VertexBuffer(MatrixEngine::VertexBuffer && vertexBuffer) noexcept {
        m_id = vertexBuffer.m_id;
        vertexBuffer.m_id = 0;
    }
